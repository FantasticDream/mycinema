...
import com.example.hello.view.VideoView;
...
public class SystemVideoPlayer extends Activity implements View.OnClickListener{
    ...
    private void showSwitchDialog() {
        ...
        builder.setTitle("提示");
        builder.setMessage("如果没有画面，请切换万能播放器尝试!");
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case SHOW_SPEED:
                    // 得到网速
                    String netSpeed = MyUtil.getNetSpeed(SystemVideoPlayer.this);
                    // 显示网速
